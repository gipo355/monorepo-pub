...
- **1 Internal Library**
  - `@gipo355/utils` - Shared utilities (private, not published)
...
| ------------------ | --------------- | ---------------------- |
| `@gipo355/utils`   | `scope:shared`  | Nothing (base library) |
| `@gipo355/strings` | `scope:strings` | `scope:shared`         |
| `@gipo355/async`   | `scope:async`   | `scope:shared`         |
| `@gipo355/colors`  | `scope:colors`  | `scope:shared`         |
...
1. Try importing `@gipo355/colors` into `@gipo355/strings`
