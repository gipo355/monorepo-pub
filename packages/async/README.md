...
```typescript
import { retry, createRetry, withRetry, TimeoutError } from '@gipo355/async';
...
- `@gipo355/utils` (tagged with `scope:shared`)

Attempting to import from `@gipo355/colors` or `@gipo355/strings` will result in a linting error due to module boundary constraints.
