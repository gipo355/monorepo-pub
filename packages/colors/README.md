...
```typescript
import { hexToRgb, rgbToHex, lighten, darken } from '@gipo355/colors';
...
Attempting to import from `@gipo355/strings` or `@gipo355/async` will result in a linting error due to module boundary constraints.
