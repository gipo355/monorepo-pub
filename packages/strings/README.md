...
```typescript
import { capitalize, slugify } from '@gipo355/strings';
...
Attempting to import from `@gipo355/colors` or `@gipo355/async` will result in a linting error due to module boundary constraints.
